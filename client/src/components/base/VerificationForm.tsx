    ...
    <div className="border-0 sm:border sm:border-solid border-tertiary-text rounded text-primary-text px-4">
      ...
      <div className="flex items-center mb-6">
        ...
        <TextInput
          ...
          required={false}
          tooltip="
          In order to successfully verify, please make sure that you are a public member of the Github organization. Organization and user names are case sensitive.
          "
          feedback={{ type: "none", message: "" }}
        />
        <Github
